                    ...
                    <form action="<?php echo e(route('bahan.dasar.update',['id'=>$bahan_dasar->id])); ?>" method="POST" >
                        ...
                        <div class="mb-3">
                            ...
                            <select name="kategori_bahan_id" id="kategori_bahan_id" class="form-control">
                                ...
                                <?php if($kategori_bahan->id == $bahan_dasar->kategori_bahan_id): ?>
                                <option value="<?php echo e($kategori_bahan->id); ?>"selected><?php echo e($kategori_bahan->nama_kategori_bahan); ?></option>
                                <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pos-laravel-server\resources\views/bahan_dasar/edit-bahan-dasar.blade.php ENDPATH**/ ?>