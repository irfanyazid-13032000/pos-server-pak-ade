...
<div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('bahan.tambahan.produksi.update',['id'=>$id])); ?>" method="POST" >
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            ...
                            <select name="warehouse_id" id="warehouse_id" class="form-control">
                                ...
                                <?php if($bahan_tambahan_produksi->warehouse_id == $warehouse->id): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pos-laravel-server\resources\views/bahan_tambahan_produksi/edit-bahan-tambahan-produksi.blade.php ENDPATH**/ ?>