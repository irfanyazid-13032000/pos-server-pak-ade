...
<div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('outlet.update',['id'=>$outlet->id])); ?>" method="POST" enctype="multipart/form-data" >
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name_outlet" name="name_outlet"
                                value="<?php echo e($outlet->name_outlet); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="warehouse_id" id="" class="form-control">
                              ...
                              <?php if($warehouse->id == $outlet->warehouse_id): ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="address_outlet" name="address_outlet"
                                value="<?php echo e($outlet->address_outlet); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="contact_outlet" name="contact_outlet"
                                value="<?php echo e($outlet->contact_outlet); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="no_telp" name="no_telp"
                                value="<?php echo e($outlet->no_telp); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pos-laravel-server\resources\views/outlet/edit-outlet.blade.php ENDPATH**/ ?>